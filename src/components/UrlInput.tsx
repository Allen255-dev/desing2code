...
export default function UrlInput({ onImageFetched }: UrlInputProps) {
    ...
    return (
        <div className="w-full h-full flex flex-col items-center justify-center p-8 space-y-6">
            ...
            <div className="text-center space-y-2">
                <h3 className="text-xl font-medium text-white">Capture from URL</h3>
                <p className="text-sm text-gray-400 max-w-sm mx-auto">
                    Enter any website URL to capture its design and convert it to code.
                </p>
            </div>

            <div className="w-full max-w-md space-y-4">
                <div className="space-y-1.5">
                    <label className="text-xs font-medium text-gray-400 uppercase tracking-wider ml-1">Website URL</label>
                    <div className="relative group">
                        <Globe className="absolute left-3 top-1/2 -translate-y-1/2 w-4 h-4 text-gray-500 group-focus-within:text-primary transition-colors" />
                        <input
                            type="text"
